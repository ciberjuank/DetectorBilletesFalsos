...
public enum CurrencyInfoKey {
	...
	EURO_ALL_WATERMARK("eur_all_watermark"),
	EURO_ALL_DESCRIPTION("eur_all_description"),
	PESO_MEX_ALL_WATERMARK("pmex_all_watermark"),
	PESO_MEX_ALL_DESCRIPTION("pmex_all_description");
