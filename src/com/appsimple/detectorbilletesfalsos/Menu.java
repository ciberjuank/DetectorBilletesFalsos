...
public class Menu extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TextView btngopro = (TextView) findViewById(R.id.btngopro);
		btngopro.setText(R.string.btngopro);
		btngopro.setTypeface(font2);
		btngopro.setOnClickListener(new OnClickListener() {
		...
		btninfo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
...

				{
					...
					Intent browserIntent = new Intent(
							Intent.ACTION_VIEW,
							Uri.parse("https://play.google.com/store/apps/details?id=com.appsimple.avoidcounterfeitgetinfo"));
					startActivity(browserIntent);
	...
	/*	TextView btninfo = (TextView) findViewById(R.id.btninfo);
		btninfo.setText(R.string.btnstart);
		...
		btninfo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
...

				{
					...
					Intent start = new Intent(Menu.this, Information.class);
...
if (settings.getBoolean("showgame", true)) 
	
{
		AlertDialog.Builder alertbox = new AlertDialog.Builder(
				Menu.this);
		alertbox.setTitle(R.string.propagandatitulo);
		// alertbox.setIcon(R.drawable.icon);
		alertbox.setCancelable(false);
		alertbox.setMessage(R.string.txtpropaganda);

		alertbox.setPositiveButton(R.string.propagandano,
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
		...
		alertbox.setNegativeButton(R.string.propagandayes,
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						
						editor.putBoolean("showgame" , false);
						editor.commit();
						Intent browserIntent = new Intent(
							
								Intent.ACTION_VIEW,
								Uri.parse("https://play.google.com/store/apps/details?id=com.appsimple.turnonthelights"));
						startActivity(browserIntent);
